          ...
          body: BlocConsumer(
            ...
            listener: (context, state) {
              ...
              if (state is LoginUserFetchState) {
                log('SUCESSS');
                log(state.responseModel.loginUserData!.id.toString());
                loginBloc.add(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: CustomTextField(
                                          ...
                                          onObscureTap: () => loginBloc
                                              .add(LoginPasswordEvent()),
